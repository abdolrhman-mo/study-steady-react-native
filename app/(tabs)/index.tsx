...
import { View, TouchableOpacity, Modal, Alert, Text } from 'react-native';
...
const CIRCLE_LENGTH = 1000; // Circumference of the circle
    ...
    <Svg width={320} height={320}>
        <G rotation="-90" origin="160, 160">
            ...
            <Circle
                cx="160"
                cy="160"
                r={CIRCLE_LENGTH / (2 * Math.PI)} // Calculated radius
                stroke="#eee" // Light gray background ring
                strokeWidth={8}
                fill="none"
            />
            {/* Progress Circle */}
            <Circle
                ...
                stroke="#E87C39" // Your app's orange color
                strokeWidth={8}
                fill="none"
                strokeDasharray={`${((duration * 60 - timeLeft) / (duration * 60)) * CIRCLE_LENGTH},${CIRCLE_LENGTH}`}
                strokeLinecap="round"
            />
        </G>
        {/* Timer Text */}
        <SvgText
            ...
            fontSize={48}
            fontWeight="bold"
            fill="#E87C39" // Orange text to match your theme
        >
            {formatTime(timeLeft)}
        </SvgText>
    </Svg>
